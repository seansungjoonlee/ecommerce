...
class Products extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({productItems: products.sort(function(a,b){return b-a})});
  }
      ...
      return(
        <div className="card" key={item.id}>
          <div className="card-image">
            ...
            <Fab color="secondary" aria-label="Add" onClick={event => this.handleAddButton(event, item.id)}>
              <AddIcon />
            </Fab>
  ...
  render() {
    return(
      <div>
        ...
        <JwPagination items={this.state.productItems} onChangePage={this.onChangePage} pageSize={5}/>
